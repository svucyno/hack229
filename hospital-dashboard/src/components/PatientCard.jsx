...
export default function PatientCard({ patient, hospitalId }) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden text-gray-200">
      ...
      <div className="flex-1 overflow-y-auto space-y-6 pr-2">
        ...
        <div className="bg-navy-800 p-4 rounded-xl border border-navy-700">
          ...
          <div className="grid grid-cols-2 gap-4 font-mono text-sm">
            <div><span className="text-gray-500 block mb-1">Blood Type:</span><span>O+</span></div>
            <div>
      ...
      <div className="mt-4 pt-4 border-t border-navy-700 shrink-0 grid grid-cols-2 gap-3">
        <button 
        ...
        <button 
          ...
          disabled={arrived}
          className={`py-3 rounded-lg font-bold font-sans flex items-center justify-center gap-2 transition-colors
            ${arrived ? 'bg-blue-500/20 text-blue-400 border border-blue-500/50' : 'bg-blue-600/20 text-blue-400 border border-blue-600/50 hover:bg-blue-600 hover:text-white'}`}
        >
